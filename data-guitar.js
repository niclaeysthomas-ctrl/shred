...
{id:"cu1", culture:true, title:"1900-1936 · Le blues du Delta : tout part de là",
content:[
"Toute la musique que tu joues descend d'un endroit : le delta du Mississippi, début du XXe siècle. Des travailleurs noirs des plantations, des guitares acoustiques bon marché, et une idée révolutionnaire : la <b>gamme blues</b> — des notes « tordues » (bendées) qui n'existent pas dans la musique européenne, héritées des chants africains.",
"La forme se fixe vite : <b>12 mesures, 3 accords</b> (ta grille de la Jam Station), et le principe appel-réponse — la voix chante, la guitare répond. Le guitariste emblème : <b>Robert Johnson</b> (1911-1938), 29 chansons enregistrées, mort à 27 ans, et une légende de pacte avec le diable au croisement des routes 61 et 49.",
"Pourquoi ça te concerne : ta penta mineure, tes bends, ton vibrato — tout est déjà chez Johnson. Le rock n'a rien inventé : il a électrifié."],
q:[
{q:"La structure du blues classique, c'est :",opts:["12 mesures, 3 accords","8 mesures, 4 accords","16 mesures, 2 accords","32 mesures, jazz"],a:0,exp:"I-IV-V sur 12 mesures — la grille que tu joues dans la Jam Station vient directement du Delta."},
{q:"Ce que le blues a apporté d'unique à la musique occidentale :",opts:["Le solfège","Les notes bendées « entre les cases », héritées des chants africains","La guitare 6 cordes","Le métronome"],a:1,exp:"Les blue notes n'existent pas sur un piano — il faut les tordre. La guitare, elle, sait bender : mariage parfait."}]},
{id:"cu2", culture:true, title:"1936-1950 · L'électrification : la guitare prend le pouvoir",
content:[
"Problème des années 30 : dans les big bands de jazz, la guitare acoustique est INAUDIBLE derrière les cuivres. Solution : le micro électromagnétique. La Gibson <b>ES-150</b> (1936) et son pionnier <b>Charlie Christian</b> font de la guitare un instrument SOLISTE — pour la première fois, elle joue des lignes comme un saxophone.",
"Puis deux inventeurs se disputent l'étape suivante : la guitare à <b>corps plein</b> (solid body), qui supprime les larsens et permet le volume. <b>Leo Fender</b>, réparateur de radios qui ne savait pas jouer, sort la <b>Telecaster</b> (1950) — une planche avec un manche vissé, pensée comme un outil d'usine, réparable pièce par pièce. Gibson répond avec la <b>Les Paul</b> (1952) : corps acajou, plus chaude, plus lourde, plus chic.",
"En 1954, Fender récidive avec la <b>Stratocaster</b> : trois micros, un vibrato, un corps sculpté. Les trois guitares que tu vois sur toutes les scènes du monde ont donc 70 ans — le design parfait n'a jamais eu besoin d'être remplacé."],
q:[
{q:"Pourquoi la guitare solid body a-t-elle été inventée ?",opts:["Pour être plus légère","Pour supprimer les larsens et monter le volume","Pour coûter moins cher","Pour le look"],a:1,exp:"Une caisse creuse amplifiée hurle (larsen). Le corps plein ne résonne pas : on peut pousser l'ampli. Le rock devient physiquement possible."},
{q:"Telecaster, Les Paul, Stratocaster datent de :",opts:["1930-1936","1950-1954","1965-1970","1980-1985"],a:1,exp:"Quatre ans qui ont dessiné 70 ans de musique. Tu peux acheter neuves aujourd'hui les trois mêmes guitares."}]},
{id:"cu3", culture:true, title:"1955-1965 · Chuck Berry invente le vocabulaire rock",
content:[
"Le rock'n'roll naît quand le blues électrifié rencontre la country et un public adolescent blanc qui a de l'argent de poche. <b>Chuck Berry</b> en écrit le dictionnaire guitaristique : les <b>double-stops</b> (deux cordes en même temps), l'intro de « Johnny B. Goode » (1958), le riff comme SLOGAN. Écoute 30 secondes de Berry : tu reconnaîtras la moitié d'AC/DC.",
"En parallèle, dans les studios, des session men inventent le métier de guitariste d'enregistrement, et <b>le riff</b> devient l'unité de base de la musique populaire : une phrase courte, répétée, qui EST la chanson (« Satisfaction », 1965, sort d'une pédale fuzz branchée par accident).",
"L'Angleterre écoute tout ça religieusement : Clapton, Richards, Page apprennent en copiant note à note les disques de blues américains — exactement comme toi avec tes morceaux-examens. La boucle d'apprentissage n'a pas changé."],
q:[
{q:"L'apport guitaristique majeur de Chuck Berry :",opts:["Le tapping","Les double-stops et le riff-slogan","Le sweep picking","La 7 cordes"],a:1,exp:"Deux cordes ensemble, une phrase qui claque comme une pub : le vocabulaire de base du rock, encore utilisé tel quel."},
{q:"Les guitaristes anglais des années 60 ont appris :",opts:["Au conservatoire","En copiant note à note les disques de blues américains","Avec des tablatures Internet","Par génération spontanée"],a:1,exp:"Clapton et Page ont fait exactement ce que tu fais avec tes morceaux-examens. La méthode a 60 ans et elle marche toujours."}]},
{id:"cu4", culture:true, title:"1966-1970 · Hendrix : quatre ans qui changent tout",
content:[
"<b>Jimi Hendrix</b> ne joue pas mieux que les autres : il joue AUTRE CHOSE. Le larsen devient une note. La pédale <b>wah-wah</b> et la <b>fuzz</b> deviennent des voix. La Stratocaster (à l'envers — il est gaucher sur guitare de droitier) devient un orchestre. Son « Star-Spangled Banner » à Woodstock (1969) — l'hymne américain transformé en bombardement sonore — reste LE manifeste : la guitare électrique est un instrument à part entière, pas une guitare acoustique plus forte.",
"Techniquement, il fusionne tout ce qui précède : accords et mélodie EN MÊME TEMPS (ses fameux accords-caresses sur « Little Wing », ton morceau-examen de palier 4), rythmique et solo indissociables, pouce par-dessus le manche.",
"Mort à 27 ans après seulement 4 ans de carrière discographique. Tout guitariste électrique depuis 1970 est soit influencé par Hendrix, soit influencé par des gens influencés par Hendrix. Il n'y a pas de troisième catégorie."],
q:[
{q:"L'apport conceptuel d'Hendrix :",opts:["Jouer plus vite que tout le monde","Faire de l'électrique + effets un instrument À PART, pas une acoustique amplifiée","Inventer la pentatonique","Le premier à jouer debout"],a:1,exp:"Larsen contrôlé, wah, fuzz, vibrato de manche : le SON devient une matière expressive. Avant lui on amplifiait, après lui on sculpte."},
{q:"« Little Wing » illustre sa technique de :",opts:["Sweep picking","Accords et mélodie fusionnés dans la même main","Tapping à deux mains","Slide au bottleneck"],a:1,exp:"Ton morceau-examen tier 4 : les accords qui chantent. La rythmique EST le solo — c'est pour ça qu'il est si dur."}]},
{id:"cu5", culture:true, title:"1968-1980 · Le riff devient religion : hard rock et heavy metal",
content:[
"Prends le blues, monte le volume, assombris : <b>Black Sabbath</b> (Birmingham, 1968) désaccorde ses guitares (Tony Iommi a perdu le bout de deux doigts en usine — cordes détendues pour jouer moins douloureusement) et invente le <b>metal</b> : tempos lourds, riffs en penta mineure, triton diabolique.",
"<b>Led Zeppelin</b> fait l'autre branche : le hard rock — blues survitaminé, riffs olympiens (« Whole Lotta Love »), et « Stairway to Heaven » (ton tier 3) qui fait entrer l'arpège folk dans le rock. <b>AC/DC</b> réduit la formule à l'os : deux accords, un groove, aucune note inutile — la preuve que la simplicité est une discipline, pas une paresse.",
"Le son : ampli <b>Marshall</b> poussé jusqu'à la saturation naturelle. La distorsion n'était pas prévue par les ingénieurs — c'est un DÉFAUT devenu esthétique, comme le larsen d'Hendrix. L'histoire de la guitare électrique est une histoire de mauvais usages géniaux."],
q:[
{q:"Pourquoi Tony Iommi (Black Sabbath) détendait-il ses cordes ?",opts:["Pour le son plus grave uniquement","Accident d'usine : deux bouts de doigts perdus, cordes détendues = jouables","Mode de l'époque","Économie de cordes"],a:1,exp:"Un accident industriel a créé le son du metal : cordes molles, donc accordage grave, donc lourdeur. L'histoire tient à rien."},
{q:"La distorsion est née :",opts:["D'un circuit conçu exprès","D'amplis poussés au-delà de leurs limites — un défaut devenu esthétique","D'une pédale japonaise","Du punk"],a:1,exp:"Saturer un Marshall était un mauvais usage. Comme le larsen, comme le scratch : les révolutions sonores sont des accidents adoptés."}]},
{id:"cu6", culture:true, title:"1978-1990 · La course à l'armement : le shred",
content:[
"1978 : <b>Eddie Van Halen</b> publie « Eruption », 1 min 42 de solo. Le <b>tapping à deux mains</b> (ton module technique !) y explose au grand jour. S'ouvre la décennie de la virtuosité : <b>Randy Rhoads</b>, <b>Yngwie Malmsteen</b> (le néoclassique : Bach + Marshall), <b>Steve Vai</b>, <b>Joe Satriani</b>. Les guitares suivent : les <b>superstrats</b> (Ibanez, Jackson) — manches plats et fins, 24 cases, vibratos flottants Floyd Rose qui tiennent l'accord malgré les plongées.",
"Le mot <b>shred</b> (déchiqueter) naît là — c'est le nom de ton app. L'époque a ses excès (la vitesse pour la vitesse), mais elle laisse un héritage réel : la technique moderne — legato, sweep, tapping — que ton onglet Forge enseigne, codifiée dans les années 80.",
"La leçon à en tirer, 40 ans plus tard : les shreddeurs qui ont survécu (Vai, Satriani) sont ceux qui phrasent. Ceux qui n'avaient QUE la vitesse ont disparu avec la décennie. Ton app te fait bosser le vibrato avant le sweep — c'est voulu."],
q:[
{q:"« Eruption » (1978) a popularisé :",opts:["Le slide","Le tapping à deux mains","Le fingerpicking","L'open tuning"],a:1,exp:"Van Halen n'a pas inventé le tapping mais l'a rendu inévitable. Ton module technique descend en droite ligne de ces 102 secondes."},
{q:"Les shreddeurs des années 80 encore écoutés aujourd'hui sont ceux qui :",opts:["Jouaient le plus vite","Phrasaient — la vitesse au service de la musique","Avaient les meilleures guitares","Criaient le plus fort"],a:1,exp:"La vitesse est un moyen. Le phrasé est la fin. C'est le message de ta fiche th5, validé par 40 ans de darwinisme musical."}]},
{id:"cu7", culture:true, title:"1976-1995 · Le contre-feu : punk et grunge",
content:[
"Pendant que le shred s'envole, deux mouvements tirent dans l'autre sens. Le <b>punk</b> (1976 : Ramones, Sex Pistols) : trois accords, deux minutes, zéro solo — un rejet POLITIQUE de la virtuosité, « n'importe qui peut le faire, alors fais-le ». Des power chords en croches, et l'énergie comme seule vertu.",
"Puis le <b>grunge</b> (Seattle, 1991) : <b>Nirvana</b> assassine les années 80 en une chanson (« Smells Like Teen Spirit » — quatre power chords). <b>Kurt Cobain</b> joue des guitares pas chères, des solos qui doublent la mélodie chantée (écoute « Come As You Are », ton morceau-examen tier 1 : le solo EST le refrain), et remet le SONGWRITING au-dessus de la technique.",
"Pourquoi les deux comptent pour toi : ils rappellent que la guitare sert des CHANSONS. Ton app te fait shredder ET jouer Come As You Are — les deux écoles, parce que l'histoire a tranché : il faut les deux."],
q:[
{q:"Le principe du solo grunge façon Cobain :",opts:["Le plus rapide possible","Doubler la mélodie chantée — le solo EST le refrain","Improvisé différent chaque soir","Pas de solo du tout"],a:1,exp:"Come As You Are, ton tier 1 : le solo rejoue le chant. Anti-virtuose et ultra-mémorable — une leçon de composition."},
{q:"Le punk était un rejet de :",opts:["La guitare électrique","La virtuosité comme condition d'accès à la scène","Des amplis Marshall","Du blues"],a:1,exp:"« Voici trois accords, maintenant monte un groupe » — le fanzine punk résumait tout. Démocratisation par la simplicité."}]},
{id:"cu8", culture:true, title:"1995-aujourd'hui · L'ère de tous les possibles",
content:[
"Depuis 25 ans, plus de « courant » unique — tout coexiste et se mélange. Le metal moderne descend (7, 8 cordes, <b>djent</b>), le blues renaît (John Mayer, Gary Clark Jr.), l'indie assume le lo-fi, et des ovnis comme <b>Tosin Abasi</b> ou <b>Tim Henson</b> (Polyphia) fusionnent shred, funk et hip-hop — la virtuosité est revenue, mais groovy et sans distorsion.",
"La vraie révolution est ailleurs : <b>la chambre a remplacé le studio</b>. Amplis simulés (plugins, Kemper), enregistrement maison, YouTube comme conservatoire mondial. Le guitariste de 2026 apprend plus vite que Clapton en 1966 — il a accès à TOUT, y compris aux tutos frame par frame. Ton app fait partie de cette histoire-là.",
"Et la guitare elle-même ? Toujours une Telecaster, une Les Paul, une Strat pour l'essentiel. 70 ans après, le grand design tient. Ce qui change, c'est tout ce qu'il y a autour — et surtout, ce que TU en joues. L'histoire n'est pas finie : elle attend ton chapitre. (Fin de la série — retourne bosser tes gammes.)"],
q:[
{q:"La révolution guitaristique des 25 dernières années est surtout :",opts:["Une nouvelle forme de guitare","La démocratisation : home studio, simulation d'amplis, YouTube","Un nouveau courant dominant","La fin de l'électrique"],a:1,exp:"Le matériel de studio d'Abbey Road tient dans un laptop. La barrière n'est plus l'accès — c'est la discipline. D'où cette app."},
{q:"Les guitares dominantes aujourd'hui sont :",opts:["Des designs de 2010+","Les mêmes qu'en 1954 : Tele, Les Paul, Strat","Des guitares MIDI","Des 12 cordes"],a:1,exp:"Le design parfait ne vieillit pas. Les trois reines de 1950-54 règnent toujours — c'est unique dans l'histoire industrielle."}]},
{id:"th7", title:"Accorder sans accordeur : la méthode de la case 5",
content:[
"Un jour ta batterie sera morte, et un guitariste qui dépend de son accordeur est un guitariste à moitié autonome. La méthode historique tient en une phrase : <b>la case 5 d'une corde = la corde suivante à vide</b>. Mi grave case 5 = La. La case 5 = Ré. Ré case 5 = Sol. <b>Exception : Sol case 4 = Si</b> (l'anomalie du Si, encore et toujours — ta fiche f3). Puis Si case 5 = Mi aigu.",
"Le geste : joue les deux notes ENSEMBLE et écoute le <b>battement</b> — cette ondulation « wouwouwou » quand deux notes sont presque identiques. Plus le battement est lent, plus tu es proche ; quand il disparaît, c'est juste. Tu n'accordes pas à la hauteur, tu accordes au battement : c'est physique, pas musical, et ça marche même avec une oreille débutante.",
"Il te faut UNE référence pour la première corde (diapason, piano, ou ton accordeur pour le Mi grave seul) — ensuite la guitare s'accorde sur elle-même. La salle 🔧 ci-dessous entraîne exactement ce réflexe : entendre si une note est trop grave, juste, ou trop aiguë."],
q:[
